...
public class WorldGenRedGlow2 extends WorldGenerator {
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_,
		...
		if (!p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_, p_76484_5_)) {
			return false;
		} else if (p_76484_1_.getBlock(p_76484_3_, p_76484_4_ + 1,
				p_76484_5_) != Blocks.netherrack) {
			return false;
		} else {
			p_76484_1_.setBlock(p_76484_3_, p_76484_4_, p_76484_5_,
					BlockList.redGlow, 0, 2);
			...
			for (int l = 0; l < 1500; ++l) {
				...
				if (p_76484_1_.getBlock(i1, j1, k1)
					...
					for (int i2 = 0; i2 < 6; ++i2) {
						...
						if (block == BlockList.redGlow) {
							++l1;
						}
					}
					
					if (l1 == 1) {
						p_76484_1_.setBlock(i1, j1, k1, BlockList.redGlow, 0,
								2);
					}
				}
			}
