...
public class ZaneWorldGenMinable extends WorldGenerator {
	...
	public ZaneWorldGenMinable(Block p_i45459_1_, int p_i45459_2_) {
		this(p_i45459_1_, p_i45459_2_, Blocks.air);
	}
	
	public ZaneWorldGenMinable(Block p_i45460_1_, int p_i45460_2_,
			Block p_i45460_3_) {
	...
	public ZaneWorldGenMinable(Block block, int meta, int number,
			Block target) {
	...
	@Override
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_,
			int p_76484_4_, int p_76484_5_) {
		float f = p_76484_2_.nextFloat() * (float) Math.PI;
		double d0 = p_76484_3_ + 8
				+ MathHelper.sin(f) * this.numberOfBlocks / 8.0F;
		double d1 = p_76484_3_ + 8
				- MathHelper.sin(f) * this.numberOfBlocks / 8.0F;
		double d2 = p_76484_5_ + 8
				+ MathHelper.cos(f) * this.numberOfBlocks / 8.0F;
		double d3 = p_76484_5_ + 8
				- MathHelper.cos(f) * this.numberOfBlocks / 8.0F;
		...
		for (int l = 0; l <= this.numberOfBlocks; ++l) {
			...
			double d10 = (MathHelper
					.sin(l * (float) Math.PI / this.numberOfBlocks) + 1.0F) * d9
					+ 1.0D;
						...
						if (d12 * d12 + d13 * d13 < 1.0D) {
							for (int i3 = k1; i3 <= j2; ++i3) {
								...
								if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D
										&& p_76484_1_.getBlock(k2, l2, i3)
												.isReplaceableOreGen(p_76484_1_,
														k2, l2, i3,
														field_150518_c)) {
									p_76484_1_.setBlock(k2, l2, i3,
											this.field_150519_a,
											mineableBlockMeta, 2);
								}
							}
