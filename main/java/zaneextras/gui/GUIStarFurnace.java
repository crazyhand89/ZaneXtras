...
public class GUIStarFurnace extends GuiContainer{
	...
	public GUIStarFurnace(InventoryPlayer invPlayer, TileEntityStarFurnace tile) {
		super(new TMContainerStarFurnace(invPlayer, tile));
