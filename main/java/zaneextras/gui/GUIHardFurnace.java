...
public class GUIHardFurnace extends GuiContainer{
	...
	public GUIHardFurnace(InventoryPlayer invPlayer, TileEntityHFurnace tile) {
		super(new TMContainerHFurnace(invPlayer, tile));
