...
public class GUICFurnace extends GuiContainer{
	...
	public GUICFurnace(InventoryPlayer invPlayer, TileEntityCFurnace tile) {
		super(new TMContainerCFurnace(invPlayer, tile));
