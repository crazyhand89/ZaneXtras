...
public class SkyProviderLight extends IRenderHandler {
	
	private static final ResourceLocation locationLightTexture = new ResourceLocation(
			ModInfo.MODID, "textures/environment/light_sky.png");
	...
	public SkyProviderLight(Minecraft p_i1249_1_) {
		this.mc = p_i1249_1_;
		this.renderEngine = p_i1249_1_.getTextureManager();
		byte b0 = 34;
		byte b1 = 16;
		this.glRenderListBase = GLAllocation
				.generateDisplayLists(b0 * b0 * b1 * 3);
		...
		if (this.occlusionEnabled) {
			...
			this.glOcclusionQueryBase = GLAllocation
					.createDirectIntBuffer(b0 * b0 * b1);
	...
	public void renderSky(float p_72714_1_) {
		...
		this.renderEngine.bindTexture(locationLightTexture);
		Tessellator tessellator = Tessellator.instance;
