...
public class ZaneWorldGenLightDungeons extends WorldGenerator {
	...
	public static final WeightedRandomChestContent[] field_111189_a = new WeightedRandomChestContent[] {
			...
			new WeightedRandomChestContent(ItemList.staria, 1, 1, 4, 4),
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_,
		...
		for (k1 = p_76484_3_ - l - 1; k1 <= p_76484_3_ + l + 1; ++k1) {
			for (l1 = p_76484_4_ - 1; l1 <= p_76484_4_ + b0 + 1; ++l1) {
				for (i2 = p_76484_5_ - i1 - 1; i2 <= p_76484_5_ + i1
						+ 1; ++i2) {
					...
					if ((k1 == p_76484_3_ - l - 1 || k1 == p_76484_3_ + l + 1
							|| i2 == p_76484_5_ - i1 - 1
							|| i2 == p_76484_5_ + i1 + 1) && l1 == p_76484_4_
		...
		if (j1 >= 1 && j1 <= 5) {
						...
						if (k1 != p_76484_3_ - l - 1 && l1 != p_76484_4_ - 1
							...
							p_76484_1_.setBlockToAir(k1, l1, i2);
								...
								&& !p_76484_1_.getBlock(k1, l1 - 1, i2)
										.getMaterial().isSolid()) {
							p_76484_1_.setBlockToAir(k1, l1, i2);
						} else if (p_76484_1_.getBlock(k1, l1, i2).getMaterial()
								.isSolid()) {
							if (l1 == p_76484_4_ - 1
									&& p_76484_2_.nextInt(4) != 0) {
								p_76484_1_.setBlock(k1, l1, i2,
										BlockList.lightStone, 0, 2);
							} else {
								p_76484_1_.setBlock(k1, l1, i2,
										BlockList.lightStone, 0, 2);
							}
				...
				while (true) {
					if (l1 < 3) {
						label101: {
							...
							int j2 = p_76484_5_ + p_76484_2_.nextInt(i1 * 2 + 1)
									- i1;
			...
			if (tileentitymobspawner != null) {
				tileentitymobspawner.func_145881_a()
						.setEntityName(this.pickMobSpawner(p_76484_2_));
			} else {
				System.err.println(
						"Failed to fetch mob spawner entity at (" + p_76484_3_
