...
public class BlockLightGrass extends Block implements IGrowable {
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 1 ? this.field_149991_b
				: (p_149691_1_ == 0 ? BlockList.lightDirt
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_,
		...
		if (!p_149674_1_.isRemote) {
			if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1,
					p_149674_4_) < 4
					&& p_149674_1_.getBlockLightOpacity(p_149674_2_,
							p_149674_3_ + 1, p_149674_4_) > 2) {
				...
				for (int l = 0; l < 4; ++l) {
					...
					if (p_149674_1_.getBlock(i1, j1, k1) == BlockList.lightDirt
							&& p_149674_1_.getBlockMetadata(i1, j1, k1) == 0
							&& p_149674_1_.getBlockLightValue(i1, j1 + 1,
									k1) >= 4
							&& p_149674_1_.getBlockLightOpacity(i1, j1 + 1,
									k1) <= 2) {
	...
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_,
			int p_149650_3_) {
		return BlockList.lightDirt.getItemDropped(0, p_149650_2_, p_149650_3_);
	}
	...
	public IIcon getIcon(IBlockAccess p_149673_1_, int p_149673_2_,
		...
		if (p_149673_5_ == 1) {
			...
			return BlockList.lightDirt.getBlockTextureFromSide(p_149673_5_);
		} else {
			Material material = p_149673_1_
					.getBlock(p_149673_2_, p_149673_3_ + 1, p_149673_4_)
					.getMaterial();
			return material != Material.snow && material != Material.craftedSnow
					? this.blockIcon : this.field_149993_M;
		}
	}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_.registerIcon("zaneextras:lightgrass_side");
		this.field_149991_b = p_149651_1_
				.registerIcon("zaneextras:lightgrass_top");
	}
		...
		while (l < 128) {
			...
			while (true) {
				if (l1 < l / 16) {
					...
					j1 += (p_149853_2_.nextInt(3) - 1) * p_149853_2_.nextInt(3)
							/ 2;
					k1 += p_149853_2_.nextInt(3) - 1;
					
					if (p_149853_1_.getBlock(i1, j1 - 1, k1) == this
					...
					if (p_149853_2_.nextInt(8) != 0) {
						if (Blocks.tallgrass.canBlockStay(p_149853_1_, i1, j1,
								k1)) {
							p_149853_1_.setBlock(i1, j1, k1, Blocks.tallgrass,
									1, 3);
						}
					} else {
						p_149853_1_.getBiomeGenForCoords(i1, k1).plantFlower(
