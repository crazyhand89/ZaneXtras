...
public class CropGeneralPepper extends BlockCrops {
	@SideOnly(Side.CLIENT)
	private IIcon[] field_149868_a;
	
	public static Item itemDropped;
	
	public CropGeneralPepper() {
		super();
		float f = 0.5F;
		this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, 0.35F,
				0.5F + f);
		this.setCreativeTab((CreativeTabs) null);
		this.setBlockName(ModInfo.MODID + "_pepper");
		this.setBlockTextureName(ModInfo.MODID + ":pepper");
