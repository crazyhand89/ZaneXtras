...
public class CropPeppercorn extends BlockCrops {
	...
	public CropPeppercorn() {
		super();
		float f = 0.5F;
		this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, 0.35F,
				0.5F + f);
		this.setCreativeTab((CreativeTabs) null);
		this.setBlockName(ModInfo.MODID + "_peppercorn");
		this.setBlockTextureName(ModInfo.MODID + ":peppercorn");
		...
		for (int l = p_149864_2_ - 1; l <= p_149864_2_ + 1; ++l) {
			for (int i1 = p_149864_4_ - 1; i1 <= p_149864_4_ + 1; ++i1) {
				...
				if (p_149864_1_.getBlock(l, p_149864_3_ - 1, i1)
					...
					if (p_149864_1_.getBlock(l, p_149864_3_ - 1, i1)
							.isFertile(p_149864_1_, l, p_149864_3_ - 1, i1)) {
						f1 = 3.0F;
					}
				}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.field_149868_a = new IIcon[7];
		for (int i = 0; i < this.field_149868_a.length; ++i) {
			this.field_149868_a[i] = p_149651_1_
					.registerIcon(this.getTextureName() + "_stage_" + i);
		}
	}
