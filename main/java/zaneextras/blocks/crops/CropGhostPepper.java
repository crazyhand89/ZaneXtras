...
public class CropGhostPepper extends BlockCrops {
	...
	public CropGhostPepper() {
		super();
		float f = 0.5F;
		this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, 0.35F,
				0.5F + f);
		this.setCreativeTab((CreativeTabs) null);
		this.setBlockName(ModInfo.MODID + "_ghost");
		this.setBlockTextureName(ModInfo.MODID + ":ghost");
