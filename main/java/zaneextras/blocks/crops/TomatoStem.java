...
public class TomatoStem extends BlockStem implements IGrowable {
	
	private Block field_149877_a = BlockList.tomatoBlock;
	@SideOnly(Side.CLIENT)
	private IIcon field_149876_b;
	
	public TomatoStem() {
		super(BlockList.tomatoStem);
		this.field_149877_a = BlockList.tomatoBlock;
		this.setTickRandomly(true);
		float f = 0.125F;
		this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, 0.25F,
				0.5F + f);
		this.setCreativeTab((CreativeTabs) null);
		this.setBlockName(ModInfo.MODID + "_tomatostem");
