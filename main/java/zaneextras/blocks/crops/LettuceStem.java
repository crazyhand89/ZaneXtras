package zaneextras.blocks.crops;
...
public class LettuceStem extends BlockStem implements IGrowable {
	
	private Block field_149877_a = BlockList.lettuceBlock;
	@SideOnly(Side.CLIENT)
	private IIcon field_149876_b;
	
	public LettuceStem() {
		super(BlockList.lettuceStem);
		this.field_149877_a = BlockList.lettuceBlock;
		this.setTickRandomly(true);
		float f = 0.125F;
		this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, 0.25F,
				0.5F + f);
		this.setCreativeTab((CreativeTabs) null);
		this.setBlockName(ModInfo.MODID + "_lettucestem");
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_,
		...
		if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1,
				p_149674_4_) >= 9) {
			float f = this.func_149875_n(p_149674_1_, p_149674_2_, p_149674_3_,
					p_149674_4_);
			...
			if (p_149674_5_.nextInt((int) (25.0F / f) + 1) == 0) {
				...
				if (l < 7) {
					...
					if (p_149674_1_.getBlock(p_149674_2_ - 1, p_149674_3_,
							p_149674_4_) == this.field_149877_a) {
						return;
					}
					...
					if (p_149674_1_.getBlock(p_149674_2_, p_149674_3_,
							p_149674_4_ - 1) == this.field_149877_a) {
						return;
					}
					...
					if (p_149674_1_.isAirBlock(j1, p_149674_3_, k1)
							&& (block.canSustainPlant(p_149674_1_, j1,
									p_149674_3_ - 1, k1, UP, this)
									|| block == Blocks.dirt
									|| block == Blocks.grass)) {
						p_149674_1_.setBlock(j1, p_149674_3_, k1,
								BlockList.lettuceBlock);
					}
				}
			}
		}
	...
	public void func_149874_m(World p_149874_1_, int p_149874_2_,
		...
		int l = p_149874_1_.getBlockMetadata(p_149874_2_, p_149874_3_,
				p_149874_4_)
	...
	private float func_149875_n(World p_149875_1_, int p_149875_2_,
		...
		float f = 1.0F;
		Block block = p_149875_1_.getBlock(p_149875_2_, p_149875_3_,
				p_149875_4_ - 1);
		Block block1 = p_149875_1_.getBlock(p_149875_2_, p_149875_3_,
				p_149875_4_ + 1);
		Block block2 = p_149875_1_.getBlock(p_149875_2_ - 1, p_149875_3_,
				p_149875_4_);
		Block block3 = p_149875_1_.getBlock(p_149875_2_ + 1, p_149875_3_,
				p_149875_4_);
		Block block4 = p_149875_1_.getBlock(p_149875_2_ - 1, p_149875_3_,
				p_149875_4_ - 1);
		Block block5 = p_149875_1_.getBlock(p_149875_2_ + 1, p_149875_3_,
				p_149875_4_ - 1);
		Block block6 = p_149875_1_.getBlock(p_149875_2_ + 1, p_149875_3_,
				p_149875_4_ + 1);
		Block block7 = p_149875_1_.getBlock(p_149875_2_ - 1, p_149875_3_,
				p_149875_4_ + 1);
		...
		for (int l = p_149875_2_ - 1; l <= p_149875_2_ + 1; ++l) {
			for (int i1 = p_149875_4_ - 1; i1 <= p_149875_4_ + 1; ++i1) {
				...
				if (block8.canSustainPlant(p_149875_1_, l, p_149875_3_ - 1, i1,
						UP, this)) {
					f1 = 1.0F;
	...
	public void setBlockBoundsBasedOnState(IBlockAccess p_149719_1_,
		...
		this.maxY = (p_149719_1_.getBlockMetadata(p_149719_2_, p_149719_3_,
				p_149719_4_) * 2 + 2) / 16.0F;
		float f = 0.125F;
	...
	@Override
	@SideOnly(Side.CLIENT)
	public int getState(IBlockAccess p_149873_1_, int p_149873_2_,
			int p_149873_3_, int p_149873_4_) {
		int l = p_149873_1_.getBlockMetadata(p_149873_2_, p_149873_3_,
				p_149873_4_);
		return l < 7 ? -1
				: (p_149873_1_.getBlock(p_149873_2_ - 1, p_149873_3_,
						p_149873_4_) == this.field_149877_a
								? 0
								: (p_149873_1_.getBlock(p_149873_2_ + 1,
										p_149873_3_,
										p_149873_4_) == this.field_149877_a
												? 1
												: (p_149873_1_.getBlock(
														p_149873_2_,
														p_149873_3_,
														p_149873_4_
																- 1) == this.field_149877_a
																		? 2
																		: (p_149873_1_
																				.getBlock(
																						p_149873_2_,
	...
	public Item getItem(World p_149694_1_, int p_149694_2_, int p_149694_3_,
		...
		return this.field_149877_a == Blocks.pumpkin ? Items.pumpkin_seeds
				: (this.field_149877_a == Blocks.melon_block ? Items.melon_seeds
						: Item.getItemById(0));
	}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_
				.registerIcon(this.getTextureName() + "_disconnected");
		this.field_149876_b = p_149651_1_
				.registerIcon(this.getTextureName() + "_connected");
	}
