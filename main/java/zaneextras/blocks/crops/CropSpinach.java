...
public class CropSpinach extends BlockCrops {
	...
	public CropSpinach() {
		...
		this.setBlockName(ModInfo.MODID + "_spinach");
		this.setBlockTextureName(ModInfo.MODID + ":spinach");
