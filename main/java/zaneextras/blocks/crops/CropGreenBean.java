...
public class CropGreenBean extends BlockCrops {
	...
	public CropGreenBean() {
		super();
		float f = 0.5F;
		this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, 0.35F,
				0.5F + f);
		this.setCreativeTab((CreativeTabs) null);
		this.setBlockName(ModInfo.MODID + "_greenbean");
		this.setBlockTextureName(ModInfo.MODID + ":greenbean");
