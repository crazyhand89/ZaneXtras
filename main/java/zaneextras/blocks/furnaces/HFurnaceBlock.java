...
public class HFurnaceBlock extends BlockContainer {
	...
	public HFurnaceBlock(boolean isActive) {
		super(Material.rock);
		this.setHardness(3.0F);
		this.setBlockName(ModInfo.MODID + "_hardFurnace");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_
				.registerIcon(ModInfo.MODID + ":hfurnaceside");
		this.front = p_149651_1_.registerIcon(
				this.isBurning2 ? ModInfo.MODID + ":hfurnaceactive"
						: ModInfo.MODID + ":hfurnaceinactive");
		this.top = p_149651_1_.registerIcon(ModInfo.MODID + ":hfurnacetop");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		player.openGui(ZaneExtrasMain.INSTANCE, 0, world, x, y, z);
		return true;
	}
	
	@Override
	public Item getItemDropped(int par1, Random random, int par3) {
		return Item.getItemFromBlock(BlockList.hFurnace);
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		 ...
		 int l = MathHelper.floor_double((double)(entity.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
	        ...
	        {
	            ((TileEntityHFurnace)world.getTileEntity(x, y, z)).furnaceName(itemstack.getDisplayName());
	        }
	}
	...
	public static void updateBlockState(boolean burning, World world, int x,
		...
		if (burning) {
			world.setBlock(x, y, z, BlockList.hFurnaceActive);
		} else {
			world.setBlock(x, y, z, BlockList.hFurnace);
		}
