...
public class SFurnaceBlock extends BlockContainer {
	...
	public SFurnaceBlock(boolean isActive) {
		super(Material.rock);
		this.setHardness(3.0F);
		this.setBlockName(ModInfo.MODID + "_solidFurnace");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_
				.registerIcon(ModInfo.MODID + ":sfurnaceside");
		this.front = p_149651_1_.registerIcon(
				this.isBurning2 ? ModInfo.MODID + ":sfurnaceactive"
						: ModInfo.MODID + ":sfurnaceinactive");
		this.top = p_149651_1_.registerIcon(ModInfo.MODID + ":sfurnacetop");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		player.openGui(ZaneExtrasMain.INSTANCE, 1, world, x, y, z);
		return true;
	}
	
	@Override
	public Item getItemDropped(int par1, Random random, int par3) {
		return Item.getItemFromBlock(BlockList.sFurnace);
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		 ...
		 int l = MathHelper.floor_double((double)(entity.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
	        ...
	        {
	            ((TileEntitySFurnace)world.getTileEntity(x, y, z)).furnaceName(itemstack.getDisplayName());
	        }
	}
	...
	public static void updateBlockState(boolean burning, World world, int x,
		...
		if (burning) {
			world.setBlock(x, y, z, BlockList.sFurnaceActive);
		} else {
			world.setBlock(x, y, z, BlockList.sFurnace);
		}
