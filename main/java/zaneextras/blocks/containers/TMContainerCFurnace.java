...
public class TMContainerCFurnace extends Container {
	...
	private TileEntityCFurnace tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;
	
	public TMContainerCFurnace(InventoryPlayer player, TileEntityCFurnace tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				}else if(TileEntityCFurnace.isItemFuel(itemstack1)){
