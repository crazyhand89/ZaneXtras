package zaneextras.blocks.containers;
...
public class TMContainerStarFurnace extends Container {
	
	private TileEntityStarFurnace tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;
	
	public TMContainerStarFurnace(InventoryPlayer player, TileEntityStarFurnace tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				}else if(TileEntityStarFurnace.isItemFuel(itemstack1)){
