...
public class TMContainerHFurnace extends Container {
	
	private TileEntityHFurnace tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;
	
	public TMContainerHFurnace(InventoryPlayer player, TileEntityHFurnace tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				}else if(TileEntityHFurnace.isItemFuel(itemstack1)){
