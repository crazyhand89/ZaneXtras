...
public class TMContainerSFurnace extends Container {
	...
	public TMContainerSFurnace(InventoryPlayer player, TileEntitySFurnace tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				}else if(TileEntitySFurnace.isItemFuel(itemstack1)){
