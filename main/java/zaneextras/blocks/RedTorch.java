...
public class RedTorch extends Block {
	public RedTorch() {
		super(Material.circuits);
		this.setBlockName(ModInfo.MODID + "_redtorch");
		this.setBlockTextureName(ModInfo.MODID + ":redtorch");
	...
	public int onBlockPlaced(World p_149660_1_, int p_149660_2_,
		...
		if (p_149660_5_ == 1 && this.func_150107_m(p_149660_1_, p_149660_2_,
				p_149660_3_ - 1, p_149660_4_)) {
			j1 = 5;
		}
		
		if (p_149660_5_ == 2 && p_149660_1_.isSideSolid(p_149660_2_,
				p_149660_3_, p_149660_4_ + 1, NORTH, true)) {
			j1 = 4;
		}
		
		if (p_149660_5_ == 3 && p_149660_1_.isSideSolid(p_149660_2_,
				p_149660_3_, p_149660_4_ - 1, SOUTH, true)) {
			j1 = 3;
		}
		
		if (p_149660_5_ == 4 && p_149660_1_.isSideSolid(p_149660_2_ + 1,
				p_149660_3_, p_149660_4_, WEST, true)) {
			j1 = 2;
		}
		
		if (p_149660_5_ == 5 && p_149660_1_.isSideSolid(p_149660_2_ - 1,
				p_149660_3_, p_149660_4_, EAST, true)) {
			j1 = 1;
		}
	...
	public void onBlockAdded(World p_149726_1_, int p_149726_2_,
		...
		if (p_149726_1_.getBlockMetadata(p_149726_2_, p_149726_3_,
				p_149726_4_) == 0) {
		...
		if (this.func_150109_e(p_150108_1_, p_150108_2_, p_150108_3_,
			...
			if (flag) {
				this.dropBlockAsItem(p_150108_1_, p_150108_2_, p_150108_3_,
						...
						0);
				p_150108_1_.setBlockToAir(p_150108_2_, p_150108_3_,
						p_150108_4_);
				return true;
			} else {
				return false;
	...
	protected boolean func_150109_e(World p_150109_1_, int p_150109_2_,
		...
		if (!this.canPlaceBlockAt(p_150109_1_, p_150109_2_, p_150109_3_,
				p_150109_4_)) {
			if (p_150109_1_.getBlock(p_150109_2_, p_150109_3_,
					p_150109_4_) == this) {
				this.dropBlockAsItem(p_150109_1_, p_150109_2_, p_150109_3_,
						p_150109_4_, p_150109_1_.getBlockMetadata(p_150109_2_,
								p_150109_3_, p_150109_4_),
						0);
				p_150109_1_.setBlockToAir(p_150109_2_, p_150109_3_,
						p_150109_4_);
			}
	...
	public MovingObjectPosition collisionRayTrace(World p_149731_1_,
			int p_149731_2_, int p_149731_3_, int p_149731_4_, Vec3 p_149731_5_,
			Vec3 p_149731_6_) {
