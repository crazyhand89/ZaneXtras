...
public class ZaneParticleOre extends ZaneBlock {
	
	double particleRed = 0.0D;
	double particleGreen = 0.0D;
	double particleBlue = 0.0D;
	
	public ZaneParticleOre(Material mat, String name, float hardness,
			float resitance, SoundType sound, int level, double red,
	...
	private void func_150186_m(World p_150186_1_, int p_150186_2_,
		...
		for (int l = 0; l < 6; ++l) {
			...
			if (d1 < p_150186_2_ || d1 > p_150186_2_ + 1 || d2 < 0.0D
					...
					|| d3 > p_150186_4_ + 1) {
				p_150186_1_.spawnParticle("reddust", d1, d2, d3,
