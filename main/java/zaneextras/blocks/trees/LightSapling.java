package zaneextras.blocks.trees;
...
import zaneextras.worldgen.WorldGenLightTree;

public class LightSapling extends BlockBush implements IGrowable {
	public static final String field_149882_a = "";
	private static IIcon field_149881_b;
	
	public LightSapling() {
		this.setCreativeTab(ZaneTabs.zTab);
		this.setBlockName(ModInfo.MODID + "_lightsapling");
		this.setBlockTextureName(ModInfo.MODID + ":sapling_light");
		float f = 0.4F;
	...
	public boolean func_149880_a(World p_149880_1_, int p_149880_2_,
		...
		return p_149880_1_.getBlock(p_149880_2_, p_149880_3_,
				p_149880_4_) == this
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149881_b = p_149651_1_.registerIcon("zaneextras:sapling_light");
	}
	...
	protected boolean canPlaceBlockOn(Block block) {
		return block == BlockList.lightGrassDirt
				|| block == BlockList.lightDirt;
	}
}