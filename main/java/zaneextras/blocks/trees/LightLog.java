...
public class LightLog extends BlockRotatedPillar {
	...
	public LightLog() {
		...
		this.setBlockName(ModInfo.MODID + "_light_log");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.field_150167_a = p_149651_1_
				.registerIcon("zaneextras:light_log_side");
		this.field_150166_b = p_149651_1_
				.registerIcon("zaneextras:light_log_top");
	}
				...
				for (int k1 = -b0; k1 <= b0; ++k1) {
					for (int l1 = -b0; l1 <= b0; ++l1) {
						...
						if (block.isLeaves(p_149749_1_, p_149749_2_ + j1,
								p_149749_3_ + k1, p_149749_4_ + l1)) {
							block.beginLeavesDecay(p_149749_1_,
									p_149749_2_ + j1, p_149749_3_ + k1,
									p_149749_4_ + l1);
						}
					}
				}
