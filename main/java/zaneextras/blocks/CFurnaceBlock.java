...
public class CFurnaceBlock extends BlockContainer {
	...
	protected CFurnaceBlock(boolean isActive) {
		super(Material.rock);
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_
				.registerIcon(ModInfo.MODID + ":cfurnaceside");
		this.front = p_149651_1_.registerIcon(
				this.isBurning2 ? ModInfo.MODID + ":cfurnaceactive"
						: ModInfo.MODID + ":cfurnaceinactive");
		this.top = p_149651_1_.registerIcon(ModInfo.MODID + ":cfurnacetop");
	}
	...
	public Item getItemDropped(int par1, Random random, int par3) {
		return Item.getItemFromBlock(BlockList.cFurnace);
	}
	...
	public static void updateBlockState(boolean burning, World world, int x,
		...
		if (burning) {
			world.setBlock(x, y, z, BlockList.cFurnaceActive);
		} else {
			world.setBlock(x, y, z, BlockList.cFurnace);
		}
