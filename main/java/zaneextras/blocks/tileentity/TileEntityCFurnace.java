...
import zaneextras.blocks.CFurnaceBlock;
import zaneextras.recipes.CurstomFurnaceRecipes;

public class TileEntityCFurnace extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.furnaceName : "Custom Furnace";
	}
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			CFurnaceBlock.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
