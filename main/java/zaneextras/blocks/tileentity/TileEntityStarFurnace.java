package zaneextras.blocks.tileentity;
...
public class TileEntityStarFurnace extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.furnaceName : "Star Furnace";
	}
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			StarFurnaceBlock.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null) {
			...
			ItemStack itemstack = CurstomFurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
	...
	public static int getItemBurnTime(ItemStack itemstack){
		if(itemstack == null){
            ...
            if (item == ItemList.radiatedCoal) return 12800;
