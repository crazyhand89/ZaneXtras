...
public class TileEntityStarFurnace extends TileEntity
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			if (this.furnaceBurnTime == 0 && this.canSmelt()) {
				this.currentBurnTime = this.furnaceBurnTime = getItemBurnTime(
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			StarFurnaceBlock.updateBlockState(this.furnaceBurnTime > 0,
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null) {
			...
			ItemStack itemstack = CurstomFurnaceRecipes.smelting()
