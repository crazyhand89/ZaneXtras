...
public class ItemFoodFrenchSalad extends ZaneItemFood {
	
	public ItemFoodFrenchSalad() {
		super("frenchsalad", 20, 2.0F, false);
	...
	protected void onFoodEaten(ItemStack p_77849_1_, World p_77849_2_,
		...
		player.addPotionEffect(
				new PotionEffect(Potion.fireResistance.id, 3600, 0));
	}
}