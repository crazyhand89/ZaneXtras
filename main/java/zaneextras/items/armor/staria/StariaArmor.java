package zaneextras.items.armor.staria;
...
public class StariaArmor extends ItemArmor {
	...
	public StariaArmor(ArmorMaterial material, String textureName, int type,
	...
	public void getSubItems(Item item, CreativeTabs creativeTab, List items) {
		ItemStack stariaArmor = new ItemStack(this, 1);
		
		stariaArmor.addEnchantment(enchanment1, amplifier1);
		stariaArmor.addEnchantment(enchanment2, amplifier2);
		items.add(stariaArmor);
	}
}
