package zaneextras.items.armor.butter;
...
public class ButterArmor extends ItemArmor {
	
	public String textureName;
	public String unName;
	
	public ButterArmor(ArmorMaterial material, String textureName, int type) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		return ModInfo.MODID + ":textures/armor/" + "butterarmor" + "_"
