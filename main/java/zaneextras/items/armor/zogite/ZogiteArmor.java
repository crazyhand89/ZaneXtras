package zaneextras.items.armor.zogite;
...
public class ZogiteArmor extends ItemArmor {
	...
	public ZogiteArmor(ArmorMaterial material, String textureName, int type,
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		return ModInfo.MODID + ":textures/armor/" + "zogitearmor" + "_"
				+ (this.armorType == 2 ? "2" : "1") + ".png";
	}
	
	@Override
	public void getSubItems(Item item, CreativeTabs creativeTab, List items) {
		ItemStack zogiteArmor = new ItemStack(this, 1);
		
		zogiteArmor.addEnchantment(enchanment, amplifier);
		items.add(zogiteArmor);
	}
}
