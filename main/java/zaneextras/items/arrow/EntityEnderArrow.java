...
public class EntityEnderArrow extends EntityArrow
	...
	public EntityEnderArrow(World p_i1754_1_, double p_i1754_2_,
	...
	public EntityEnderArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_,
	...
	public EntityEnderArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_,
			float p_i1756_3_) {
		super(p_i1756_1_);
		this.renderDistanceWeight = 10.0D;
			...
			if (block == this.field_145790_g && j == this.inData) {
				...
				if (this.ticksInGround == 1) {
					...
					if (this.shootingEntity instanceof EntityLivingBase) {
						EntityLivingBase entity = (EntityLivingBase) this.shootingEntity;
						entity.setPosition(this.posX, this.posY + 1.0D,
								this.posZ);
					}
