...
public class EntityEmeraldArrow extends EntityArrow
	...
	public EntityEmeraldArrow(World p_i1753_1_) {
		super(p_i1753_1_);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}
	
	public EntityEmeraldArrow(World p_i1754_1_, double p_i1754_2_,
	...
	public EntityEmeraldArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_,
	...
	public EntityEmeraldArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_,
			float p_i1756_3_) {
		super(p_i1756_1_);
		this.renderDistanceWeight = 10.0D;
