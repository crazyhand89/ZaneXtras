...
public class EnderBow extends Item {
	...
	public EnderBow() {
		...
		this.setUnlocalizedName(ModInfo.MODID + "_enderbow");
		this.setTextureName(ModInfo.MODID + ":enderbow");
	}
	...
	public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_,
		...
		if (flag || p_77615_3_.inventory.hasItem(ItemList.enderArrow)) {
			float f = j / 20.0F;
			f = (f * f + f * 2.0F) / 3.0F;
			...
			EntityEnderArrow entityarrow = new EntityEnderArrow(p_77615_2_,
					p_77615_3_, f * 2.0F);
			...
			if (flag) {
				...
				p_77615_3_.inventory.consumeInventoryItem(ItemList.enderArrow);
			}
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_,
		...
		if (p_77659_3_.capabilities.isCreativeMode
				|| p_77659_3_.inventory.hasItem(ItemList.enderArrow)) {
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_,
		...
		if (ZaneKeyHelper.isCtrlKeyDown() || ZaneKeyHelper.isShiftKeyDown()) {
			list.add(EnumChatFormatting.ITALIC
					+ "Missed arrows fired from this");
			list.add(EnumChatFormatting.ITALIC + "bow will teleport you where");
			list.add(EnumChatFormatting.ITALIC + "they land");
