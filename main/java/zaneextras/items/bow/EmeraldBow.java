...
public class EmeraldBow extends Item {
	...
	public EmeraldBow() {
		...
		this.setUnlocalizedName(ModInfo.MODID + "_emeraldbow");
		this.setTextureName(ModInfo.MODID + ":emeraldbow");
	}
	...
	public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_,
		...
		if (flag || p_77615_3_.inventory.hasItem(ItemList.emeraldArrow)) {
			float f = j / 20.0F;
			f = (f * f + f * 2.0F) / 3.0F;
			...
			EntityEmeraldArrow entityarrow = new EntityEmeraldArrow(p_77615_2_,
					p_77615_3_, f * 2.0F);
			...
			if (flag) {
				...
				p_77615_3_.inventory
						.consumeInventoryItem(ItemList.emeraldArrow);
			}
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_,
		...
		if (p_77659_3_.capabilities.isCreativeMode
				|| p_77659_3_.inventory.hasItem(ItemList.emeraldArrow)) {
