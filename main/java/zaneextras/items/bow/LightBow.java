...
public class LightBow extends Item {
	...
	public LightBow() {
		...
		this.setUnlocalizedName(ModInfo.MODID + "_lightbow");
		this.setTextureName(ModInfo.MODID + ":lightbow");
	}
	...
	public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_,
		...
		if (flag || p_77615_3_.inventory.hasItem(ItemList.lightArrow)) {
			float f = j / 20.0F;
			f = (f * f + f * 2.0F) / 3.0F;
			...
			EntityLightArrow entityarrow = new EntityLightArrow(p_77615_2_,
					p_77615_3_, f * 2.0F);
			...
			if (flag) {
				...
				p_77615_3_.inventory.consumeInventoryItem(ItemList.lightArrow);
			}
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_,
		...
		if (p_77659_3_.capabilities.isCreativeMode
				|| p_77659_3_.inventory.hasItem(ItemList.lightArrow)) {
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_,
		...
		if (ZaneKeyHelper.isCtrlKeyDown() || ZaneKeyHelper.isShiftKeyDown()) {
			...
			list.add(EnumChatFormatting.ITALIC + "bow pack a big punch");
