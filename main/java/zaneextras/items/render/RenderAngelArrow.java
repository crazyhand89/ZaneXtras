...
public class RenderAngelArrow extends Render {
	private static final ResourceLocation arrowTextures = new ResourceLocation(
			"zaneextras:textures/entity/angelarrow.png");
	 ...
	 */
	public void doRender(EntityAngelArrow p_76986_1_, double p_76986_2_,
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityAngelArrow p_110775_1_) {
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return this.getEntityTexture((EntityAngelArrow) p_110775_1_);
	}
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		this.doRender((EntityAngelArrow) p_76986_1_, p_76986_2_, p_76986_4_,
