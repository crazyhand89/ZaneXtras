...
public class RenderEnderArrow extends Render {
	private static final ResourceLocation arrowTextures = new ResourceLocation(
			"zaneextras:textures/entity/enderarrow.png");
	 ...
	 */
	public void doRender(EntityEnderArrow p_76986_1_, double p_76986_2_,
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityEnderArrow p_110775_1_) {
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return this.getEntityTexture((EntityEnderArrow) p_110775_1_);
	}
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		this.doRender((EntityEnderArrow) p_76986_1_, p_76986_2_, p_76986_4_,
