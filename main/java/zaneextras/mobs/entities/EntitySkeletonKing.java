...
public class EntitySkeletonKing extends EntityMob
		implements IRangedAttackMob, IBossDisplayData {
	...
	public EntitySkeletonKing(World p_i1741_1_) {
		super(p_i1741_1_);
		...
		this.addPotionEffect(
				new PotionEffect(Potion.regeneration.id, 1000000, 1));
		this.addPotionEffect(
				new PotionEffect(Potion.resistance.id, 1000000, 1));
	...
	protected void addRandomArmor() {
		...
		this.setCurrentItemOrArmor(0, new ItemStack(ItemList.skeleBow));
	}
	...
	public void setCombatTask() {
		...
		if (itemstack != null && itemstack.getItem() == ItemList.skeleBow) {
	...
	public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_,
			float p_82196_2_) {
		EntityGoldenArrow entityarrow = new EntityGoldenArrow(this.worldObj,
	...
	/**
	 * Returns the total armor of the Entity.
	 */
	@Override
