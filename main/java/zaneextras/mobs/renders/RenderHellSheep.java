...
public class RenderHellSheep extends RenderLiving {
	...
	public RenderHellSheep(ModelHellSheep par1ModelBase, float par2) {
		super(par1ModelBase, par2);
		model = (ModelHellSheep) mainModel;
		this.modelArmorChestplate = new ModelBiped(1.0F);
		this.modelArmor = new ModelBiped(0.5F);
	}
	
	protected void scaleHellSheep(EntityHellSheep par1EntityMob, float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleHellSheep((EntityHellSheep) par1EntityLivingBase, par2);
	}
	...
	protected void func_130005_c(EntityLiving par1EntityLiving, float par2) {
		...
		if (itemstack1 != null) {
			...
			this.model.head2.postRender(0.0625F);
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation("zaneextras:textures/entity/hellsheep.png");
	}
	
	public void renderMob(EntityHellSheep entity, double par2, double par4,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
		...
		renderMob((EntityHellSheep) par1EntityLiving, par2, par4, par6, par8,
				par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
			double par6, float par8, float par9) {
		renderMob((EntityHellSheep) par1Entity, par2, par4, par6, par8, par9);
	}
}