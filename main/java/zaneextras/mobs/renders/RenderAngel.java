...
public class RenderAngel extends RenderLiving {
	...
	public RenderAngel(ModelAngel par1ModelBase, float par2) {
	...
	protected void scaleAngel(EntityAngel par1EntityMob, float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleAngel((EntityAngel) par1EntityLivingBase, par2);
	}
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation("zaneextras:textures/entity/angel.png");
	}
	
	public void renderMob(EntityAngel entity, double par2, double par4,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
		...
		renderMob((EntityAngel) par1EntityLiving, par2, par4, par6, par8,
				par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
			double par6, float par8, float par9) {
		renderMob((EntityAngel) par1Entity, par2, par4, par6, par8, par9);
	}
}