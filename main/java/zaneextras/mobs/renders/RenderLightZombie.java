...
public class RenderLightZombie extends RenderLiving {
	public ModelLightZombie model;
	...
	public RenderLightZombie(ModelLightZombie par1ModelBase, float par2) {
		super(par1ModelBase, par2);
		model = (ModelLightZombie) mainModel;
		this.modelArmorChestplate = new ModelBiped(1.0F);
		this.modelArmor = new ModelBiped(0.5F);
	}
	
	protected void scaleLightZombie(EntityLightZombie par1EntityMob,
			float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleLightZombie((EntityLightZombie) par1EntityLivingBase, par2);
	}
	...
	protected void func_130005_c(EntityLiving par1EntityLiving, float par2) {
		...
		if (itemstack != null) {
			...
			if (itemstack.getItem() instanceof ItemBlock
				...
				GL11.glScalef(-f2, -f2, f2);
			} else if (itemstack.getItem() == ItemList.emeraldSword) {
				f2 = 0.825F;
				GL11.glTranslatef(0.0F, 0.325F, 0.0F);
				GL11.glRotatef(3.0F, 00.0F, 1.0F, 0.0F);
				GL11.glScalef(f2, -f2, f2);
				// y = 1.0f
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation(
				"zaneextras:textures/entity/lightzombie.png");
	}
	
	public void renderMob(EntityLightZombie entity, double par2, double par4,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
		...
		renderMob((EntityLightZombie) par1EntityLiving, par2, par4, par6, par8,
				par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
			double par6, float par8, float par9) {
		renderMob((EntityLightZombie) par1Entity, par2, par4, par6, par8, par9);
	}
}