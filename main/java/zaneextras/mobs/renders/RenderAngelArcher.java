package zaneextras.mobs.renders;
...
public class RenderAngelArcher extends RenderLiving {
	
	public ModelAngelArcher model;
	...
	public RenderAngelArcher(ModelAngelArcher par1ModelBase, float par2) {
		super(par1ModelBase, par2);
		model = (ModelAngelArcher) mainModel;
	...
	protected void func_82439_b(EntityLivingBase par1EntityLivingBase, int par2,
			float par3) {
	...
	protected void renderEquippedItems(EntityLiving par1EntityLiving,
			float par2) {
		float f1 = 1.0F;
		GL11.glColor3f(f1, f1, f1);
		...
		if (itemstack1 != null) {
			GL11.glPushMatrix();
			this.model.field_78114_d.postRender(0.0625F);
		...
		if (itemstack != null) {
			...
			this.model.field_78112_f.postRender(0.0625F);
			...
			if (itemstack.getItem() instanceof ItemBlock
				...
				GL11.glScalef(-f2, -f2, f2);
			} else if (itemstack.getItem() == ItemList.angelBow) {
				f2 = 0.625F;
				GL11.glTranslatef(-0.1775F, 0.125F, 0.3125F);
				GL11.glRotatef(-20.0F, 0.0F, 10.0F, 0.0F);
				GL11.glScalef(f2, -f2, f2);
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation(
				"zaneextras:textures/entity/angelarcher.png");
	}
	
	public void renderTutorial(EntityAngelArcher entity, double par2,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		renderTutorial((EntityAngelArcher) par1EntityLiving, par2, par4, par6,
				par8, par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		renderTutorial((EntityAngelArcher) par1Entity, par2, par4, par6, par8,
				par9);
	}
	
	protected void scaleAngelArcher(EntityAngelArcher par1EntityLightSkeleton,
			float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleAngelArcher((EntityAngelArcher) par1EntityLivingBase, par2);
	}
}