...
public class RenderAngelWarrior extends RenderLiving {
	
	public ModelAngelWarrior model;
	...
	public RenderAngelWarrior(ModelAngelWarrior par1ModelBase, float par2) {
		super(par1ModelBase, par2);
		model = (ModelAngelWarrior) mainModel;
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation(
				"zaneextras:textures/entity/angelwarrior.png");
	}
	
	public void renderTutorial(EntityAngelWarrior entity, double par2,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		renderTutorial((EntityAngelWarrior) par1EntityLiving, par2, par4, par6,
				par8, par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		renderTutorial((EntityAngelWarrior) par1Entity, par2, par4, par6, par8,
				par9);
	}
	
	protected void scaleAngelWarrior(EntityAngelWarrior par1EntityLightSkeleton,
			float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleAngelWarrior((EntityAngelWarrior) par1EntityLivingBase, par2);
	}
}