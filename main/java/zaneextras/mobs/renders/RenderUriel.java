...
public class RenderUriel extends RenderLiving {
	
	public ModelUriel model;
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation("zaneextras:textures/entity/uriel.png");
	}
	
	public void renderTutorial(EntityUriel entity, double par2, double par4,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
		...
		renderTutorial((EntityUriel) par1EntityLiving, par2, par4, par6, par8,
				par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
			double par6, float par8, float par9) {
		renderTutorial((EntityUriel) par1Entity, par2, par4, par6, par8, par9);
	}
	
	protected void scaleAngelWarrior(EntityUriel par1EntityLightSkeleton,
			float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleAngelWarrior((EntityUriel) par1EntityLivingBase, par2);
	}
}