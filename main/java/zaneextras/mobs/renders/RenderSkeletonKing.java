...
public class RenderSkeletonKing extends RenderLiving {
	...
	public ModelSkeletonKing model;
	...
	float f6 = 1.0F;
	public Item bowItem = ItemList.skeleBow;
	
	public RenderSkeletonKing(ModelSkeletonKing par1ModelBase, float par2) {
		super(par1ModelBase, par2);
		model = (ModelSkeletonKing) mainModel;
	 ...
	 * @return FLocation pointing at the armor's texture
	 */
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation(
				"zaneextras:textures/entity/skeletonking.png");
	}
	
	public void renderTutorial(EntitySkeletonKing entity, double par2,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		renderTutorial((EntitySkeletonKing) par1EntityLiving, par2, par4, par6,
				par8, par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		renderTutorial((EntitySkeletonKing) par1Entity, par2, par4, par6, par8,
				par9);
	}
	
	protected void scaleSkeletonKing(EntitySkeletonKing par1EntitySkeletonKing,
			float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleSkeletonKing((EntitySkeletonKing) par1EntityLivingBase, par2);
	}
}