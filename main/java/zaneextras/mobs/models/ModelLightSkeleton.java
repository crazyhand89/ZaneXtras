...
public class ModelLightSkeleton extends ModelZombie {
	/**
	...
	public ModelLightSkeleton() {
		this(0.0F);
	}
	
	public ModelLightSkeleton(float par1) {
	...
	public void setRotationAngles(float par1, float par2, float par3,
		...
		if (this.aimedBow) {
			...
			this.bipedRightArm.rotateAngleZ += MathHelper.cos(par3 * 0.09F)
					* 0.05F + 0.05F;
			this.bipedLeftArm.rotateAngleZ -= MathHelper.cos(par3 * 0.09F)
					* 0.05F + 0.05F;
			this.bipedRightArm.rotateAngleX += MathHelper.sin(par3 * 0.067F)
					* 0.05F;
			this.bipedLeftArm.rotateAngleX -= MathHelper.sin(par3 * 0.067F)
					* 0.05F;
		}
